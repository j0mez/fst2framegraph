...
COLAB_INSTALL_HINT = "\n".join(
    [
        ...
        "pip install -e .",
        "or explicitly: pip install \"protobuf>=3.20.1,<4.0.0\" \"frame-semantic-transformer==0.10.0\" \"sentencepiece==0.2.0\" \"numpy==1.26.4\" \"tqdm==4.66.4\" \"dill==0.3.8\"",
    ]
)
    ...
    *,
    ...
    if sys.version_info >= (3, 12):
        warnings.append(
            ...
            "Colab stack with requirements-colab.txt before rerunning."
        )
